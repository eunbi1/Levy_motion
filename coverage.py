...
# fid= fid_score('/scratch/private/eunbiyoon/sub_Levy/cifar10','/scratch/private/eunbiyoon/sub_Levy/CIFAR10_1.5' )
# print(f'FID{fid}')
#
# metrics = calculate_given_paths('/scratch/private/eunbiyoon/sub_Levy/cifar10', '/scratch/private/eunbiyoon/sub_Levy/CIFAR10_1.5')
# print('coverages', metrics)
#
# fid= fid_score('/scratch/private/eunbiyoon/sub_Levy/mnist_1','/scratch/private/eunbiyoon/sub_Levy/mnist_20_1' )
# print(f'FID{fid}')
#
# metrics = calculate_given_paths('/scratch/private/eunbiyoon/sub_Levy/mnist_1', '/scratch/private/eunbiyoon/sub_Levy/mnist_20_1')
# print('coverages', metrics)
#
# fid= fid_score('/scratch/private/eunbiyoon/sub_Levy/cifar10','/scratch/private/eunbiyoon/sub_Levy/CIFAR10_2.0' )
# print(f'FID{fid}')
#
# metrics = calculate_given_paths('/scratch/private/eunbiyoon/sub_Levy/cifar10', '/scratch/private/eunbiyoon/sub_Levy/CIFAR10_2.0')
# print('coverages', metrics)
