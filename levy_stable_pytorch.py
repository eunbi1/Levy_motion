...
class LevyStable:
    ...
    def score_fourier_transform(self, x: torch.Tensor, alpha, beta=0, t0=10, Fs=30, sigma_1=1, sigma_2=1):
    ...
    def score_fft(self, x: torch.Tensor, alpha, beta=0, t0=10, Fs=30, sigma_1=1, sigma_2=1):
...
class LevyGaussian:
    ...
    def __init__(self, alpha=2, sigma_1=0, sigma_2=0, beta=0, t0=30, Fs=30, type="cft"):
        self.alpha = alpha
        self.beta = beta
