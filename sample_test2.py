...
sample(alpha=1.9, path ='/home/eunbiyoon/Levy_motion-/MNIST1.9_0.1_10.0.pth',beta_min=0.1, beta_max=10, sampler='pc_sampler2', batch_size=64, num_steps=1000,LM_steps=20,Predictor=True, Corrector=False)
